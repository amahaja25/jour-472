...
**Task** Run the following code and describe the dataframe it outputs. **Answer state_data shows the 2021 education spending, change in population and growth in GDP as well as winner of the populat vote in each state.**
...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer The visualization shows a scatterplot of the change in population and gdp growth as well as a line of best fit.**
...
**Task** Run the following code. Describe the plot. What do you see? **Answer This scatterplot shows the education spending per pupil and the growth in GDP for each state in 2021.**
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer GDP Growth and per pupil spending have a low correlation.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer The output provides a p-value, confidence interval and Pearson's r correlation coefficient for per pupul spending and population change in 2021.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer The r value is -0.06, which is weaker than the previous correlation.**
...
**Task** Run the following code. Describe the table. What do you see? **Answer States that voted for Biden had a higher mean gdp growth and expenditure per pupil, but states that voted for trump had a higher mean population growth.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer The p-value is higher than 0.05, which means it is not statistically.significant.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer The p-value is very small, which means the relationship between the two is statistically significant.**

...
**Task** Run the following codeblock to calculate the percentage change and put the state with the largest percentage growth below. **Answer Nevada had the largest percentage growth.**
...
Household Income Margin of Error by county in Maryland.
...
Is the difference between Calvert and Montgomery significant? **Answer No, as the margin of error bars overlap, so the difference is not statistically significant.**

Is the difference between Howard and everyone else significant? **Answer Yes, as the error bars are quite far from each other.**
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results. **Answer For high schools that have 60% or more graduates immediately enrolling in college, the average income is $111,448.3. For high schools with less than 40% of graduates immediately enrolling in college, the average household income is \$69,252.24.**
...
**Task** What is another question you could ask of this data? **Answer What does college enrollment and high school graduation rate look like by racial demographics in addition to household income? Do counties and zipcodes with more racial homogeneity have higher or lower percentages of high school graduates? The same goes for racial diversity.**

...
#number of owners —— 158 rows, unsure what is wrong right now and how to get to the "more than 160 owners"
sportsdonation |>
  group_by(Owner) |>
  summarise(n())

#find number of owners of teams = 153
...
#some of the owners own multiple teams which were not accounted for, I believe, need to figure out 
```

...
#FiveThirtyEight had a searchable database, and we found that some of the donations that were there were not present in our data, particularly ones that affected Kelly Loeffler's bipartisan donations. Even when we tried to redownload the data, we got the same results.

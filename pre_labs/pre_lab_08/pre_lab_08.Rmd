...
The code creates baltco_911_calls_by_month, which is baltco_911_calls with a column for month. Group by and summarise narrows down the results of the output to just the month and total calls, and arrange orders the results by the highest number of calls.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer The output is just a gray box.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer The bar chart shows the count of total calls and months in chronological order.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer Now, the bars are ordered from the least number of calls to the highest, and they are no longer in order by month.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer Instead of vertical bars, the chart shows the data horizontally. The count is on the x axis instead of the y.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer The background of the chart is no longer gray.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer The theme is different, and the background color is blue and the lines are white.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer The chart now has a title**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer The code shows the total calls by date rather than by month.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer This is a line graph showing the total calls in Baltimore County over a year by date.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer Each point on the x-axis designating the date is now present, but they all overlap.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer Now the labels for date are on an angle, but they still overlap**

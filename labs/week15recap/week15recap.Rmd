...
md_childcare_counties <- childcare_inspections |> left_join(md_counties, join_by('fips' == 'geoid'))
...
md_childcare_counties <- md_childcare_counties |>
  left_join(acs_under_5, join_by('fips' == 'GEOID'))
...
md_childcare_income |>
    ...
    geom_smooth(aes(x=median_income, y=rate)), method

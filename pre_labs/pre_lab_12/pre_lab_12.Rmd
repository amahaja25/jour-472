...
**Task** Run the following code and describe the dataframe it outputs. **Answer The data frame has the 999 press releases from Sen. Ben Cardin.**
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer** The unique function gets rid of duplicates and only shows one-of-a-kind words in the output.
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer unnest_tokens makes the text lowercase and removes punctuation.**
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer The graphic shows that common words like "the" and "and" are the most common, which is not that interesting.**
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer Now the words are more interesting and are not as short.**
...
**Task** Run the following code and describe the results. **Answer The results of the code are the most common two-word phrases in order of the most common to least common. The top three most common two-word phrases were covid 19, human rights and 19 pandemic.**
...
**Task** Run the following code and describe the results. **Answer The top three most common phrases were project location, amount included and health care.**
...
**Task** Run the following code and describe the results. **Answer human rights, equal rights and health care are the top three most common two-word phrases.**
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer the word critical's sentiment depends on its usage, as you can be critical of something, which would be a negative connotation, but you can also think something is critical, which means it is important, which would be positive.**
